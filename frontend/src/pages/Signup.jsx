...
const Signup = () => {
  ...
  const handleSignUp = (event) => {
    ...
    createUser(email, password, name) // ✅ FIXED ORDER
      .then((userCredential) => {
  ...
  return (
    <section className="flex flex-col lg:flex-row h-auto lg:h-screen items-center">
      ...
      <div className="bg-indigo-600 w-full lg:w-2/3 h-64 lg:h-screen">
        <img
          src="https://plus.unsplash.com/premium_photo-1677567996070-68fa4181775a?q=80&w=1744&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          alt="Signup Visual"
      ...
      <div className="bg-white w-full md:max-w-md lg:max-w-full md:mx-auto md:w-1/2 xl:w-1/3 h-full lg:h-screen px-6 lg:px-16 xl:px-12 flex items-center justify-center">
        <div className="w-full h-full">
          <h1 className="text-xl md:text-2xl font-bold leading-tight mt-12">Signup Form</h1>
          ...
          <p className="mt-8">
            ...
            <Link to="/login" className="text-blue-500 underline hover:text-blue-700 font-semibold">
              Login
            </Link>
          </p>
        </div>
